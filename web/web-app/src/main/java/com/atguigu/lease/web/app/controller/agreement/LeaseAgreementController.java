...
public class LeaseAgreementController {
    ...
    public Result<List<AgreementItemVo>> listItem() {
        List<AgreementItemVo> result = agreementService.listItem(LoginUserHolder.getLoginUser().getUserName());
    ...
    public Result<AgreementDetailVo> getDetailById(@RequestParam Long id) {
        AgreementDetailVo agreementDetailVo = agreementService.getDetailById(id);
    ...
    public Result updateStatusById(@RequestParam Long id, @RequestParam LeaseStatus leaseStatus) {
        agreementService.updateStatus(id,leaseStatus);
        return Result.ok();
    }
