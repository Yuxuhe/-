...
public class LeaseAgreementController {
    ...
    public Result<IPage<AgreementVo>> page(@RequestParam long current, @RequestParam long size, AgreementQueryVo queryVo) {
        ...
        IPage<AgreementVo> result = leaseAgreementService.pageLease(agreementVoPage,queryVo);
    ...
    public Result<AgreementVo> getById(@RequestParam Long id) {
        AgreementVo agreementVo = leaseAgreementService.getLeaseAgreementById(id);
    ...
    public Result updateStatusById(@RequestParam Long id, @RequestParam LeaseStatus status) {
        ...
        leaseAgreementUpdateWrapper.eq(LeaseAgreement::getId,id).set(LeaseAgreement::getStatus,status);
